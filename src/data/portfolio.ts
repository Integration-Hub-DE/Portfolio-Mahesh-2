...
export const personalInfo = {
  ...
  email: 'mahesh.dataengineer@email.com',
  phone: '+1 (555) 123-4567',
  location: 'United States',
  github: 'https://github.com/mahesh-data',
  linkedin: 'https://www.linkedin.com/in/mahesh-dataengineer',
  resumeUrl: '/Mahesh_DataEngineer_Resume.pdf',
  bio: 'I am a passionate Data Engineer with deep expertise in the Microsoft data platform. I architect end-to-end data solutions — from ingestion and transformation to analytics and reporting — using Azure Data Factory, Microsoft Fabric, Databricks, and Power BI. I love turning raw data into actionable insights that drive business decisions.',
};
...
export const skillCategories = [
  ...
  },
  {
    ...
    icon: Database,
    skills: [
      { name: 'Azure Storage Account', level: 92 },
      { name: 'SQL Server', level: 90 },
      { name: 'Lakehouse', level: 88 },
      { name: 'Warehouse', level: 85 },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: 'Mirroring', level: 82 },
      { name: 'Data Integration', level: 88 },
      { name: 'Pyspark', level: 88 },
    ],
  },
  {
